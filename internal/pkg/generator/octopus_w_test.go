...
func TestGenerateOctopus(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantStr: map[string][]string{
				...
				"mock": {
					...
					`func SelectByField1MockerLogger(keys []int, res FooList) func() (logger.MockerLogger, error) {`,
		...
		},
		{
			...
			wantStr: map[string][]string{
				"mock": {
					`Code generated by argen. DO NOT EDIT.`,
					`func (obj *Foo) RepoSelector(ctx context.Context) (any, error) {`,
					`func CallMockerLogger(res FooList) func() (logger.MockerLogger, error) {`,
		...
		},
		{
			...
			wantStr: map[string][]string{
				"mock": {
					`func (obj *Foo) RepoSelector(ctx context.Context) (any, error) {`,
					`func CallMockerLogger(params FooParams, res FooList) func() (logger.MockerLogger, error) {`,
	...
	// ToDo add test for postgres
	backendObj, errB := backend.GetBackendByName("octopus")
	if errB != nil {
		t.Errorf("can't get backend: %s", errB)
	}

	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ret, got := GenerateFromDir(tt.args.params, backendObj)
			if got != tt.want {
